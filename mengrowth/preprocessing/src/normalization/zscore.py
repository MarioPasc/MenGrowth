    ...
    def visualize(
        ...
        **kwargs: Any
        ...
        try:
            ...
            axes[0, 3].axvline(mean_value, color='red', linestyle='--', linewidth=2, label=f'Mean={mean_value:.2f}')
            axes[0, 3].axvline(mean_value - std_value, color='orange', linestyle=':', linewidth=1.5, label=f'μ-σ')
            axes[0, 3].axvline(mean_value + std_value, color='orange', linestyle=':', linewidth=1.5, label=f'μ+σ')
            ...
            axes[1, 3].hist(after_nonzero, bins=100, alpha=0.7, color='green', density=True)
            axes[1, 3].axvline(0, color='red', linestyle='--', linewidth=2, label='Mean≈0')
            axes[1, 3].axvline(-self.norm_value, color='orange', linestyle=':', linewidth=1.5, label='±σ')
            axes[1, 3].axvline(self.norm_value, color='orange', linestyle=':', linewidth=1.5)
